...
export default function WhyUs() {
  return (
    <div>
      ...
      <WhyUsItem color="#57D9A3" icon="ion-golf" title="Goal Oriented Studies" description=" A person without a goal is a person without a life. You are studying everyday to achieve your goal someday. Our faculties work day and night to achieve your goal. " src="/goal.svg" reverse />
      <WhyUsItem color="#6B778C" icon="ion-wallet" title="Financial Aid" description="Economical conditions should never hinder you in your preparation as long as you study well. We provide scholarship and free classes to the economically backward students of the nation." src="/economic_support.svg" />
    </div>
  );
}
