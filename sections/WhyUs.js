...
export default function WhyUs() {
  return (
    <div>
      ...
      <WhyUsItem color='#6B778C' icon='ion-wallet' title='Financial Aid' description='Economical conditions should never hinder you in your preparation as long as you study well. We provide scholarship and free class to the economically backward students of the nation.' src='/economic_support.svg'  />
    </div>
  )
}
